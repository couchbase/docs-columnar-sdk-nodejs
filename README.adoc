= Couchbase Columnar Node.js SDK Documentation

This repository hosts the documentation source for the
https://docs.couchbase.com/columnar-nodejs-sdk/1.0/hello-world/overview.html[Couchbase Columnar Python SDK Documentation].


This branch documents the 1.0 release of the SDK.
It follows the https://docs.couchbase.com/columnar-nodejs-sdk/1.0/project-docs/compatibility.html#api-version[SDK 1.0 API].
...
| `name_platform:` | Allows us to name the SDK within shared content (*Node.js*).

| `name-sdk:` | Allows us to name the SDK within shared content (*Node.js Columnar SDK*).
